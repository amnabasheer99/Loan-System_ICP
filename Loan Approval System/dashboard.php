        ...
        <div class="row">
            ...
            <div class="col-lg-2 sidebar shadow">
                <ul class="list-unstyled">
                    ...
                    <?php if($role === 'Admin'): ?>
                        <li><a href="create-user.php" class="sidebar-link text-left">Create new User</a></li>
                        <li><a href="read-user.php" class="sidebar-link text-left">Update or Delete User</a></li>
